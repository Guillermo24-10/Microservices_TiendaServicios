...
namespace TiendaServicios.Api.Libro.Test.Fixtures
{
    public class AsyncQueryProvider<TEntity> : IAsyncQueryProvider
    {
        ...
        public TResult ExecuteAsync<TResult>(Expression expression, CancellationToken cancellationToken = default)
        {
            ...
            var ejecucionResultado = typeof(IQueryProvider).GetMethod(name: nameof(IQueryProvider.Execute), genericParameterCount: 1, types: new[] { typeof(Expression) })!.MakeGenericMethod(resultadoTipo).Invoke(this, new[] { expression });
