namespace TiendaServicios.Api.Libro.Shared.Utils
{
    public static class GlobalMessage
    {
        ...
        public const string MESSAGE_TOKEN_ERROR = "El usuario y/o contraseña es incorrecta, compruebalo";
        ...
        public const string MESSAGE_AUTH_TYPE_GOOGLE = "Por favor ingrese con la opcion de Google";
        public const string MESSAGE_AUTH_TYPE = "Su cuenta no se encuentra registrada";
    }
}
